...
public class GyroscopeXZ extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gyroscope_xz);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(GyroscopeXZ.this,GyroscopeXZ.class);
        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if (event.sensor.getType() == Sensor.TYPE_GYROSCOPE) {
                    ...
                    output[0] = "http://165.124.181.163:5000/store/"+time+"/"+macAddress+"/"+"Gyroscope/"+url_value_string;
