        ...
        magBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(x_isOn == 1 && y_isOn ==0 && z_isOn == 0){
                    ...
                    startActivity(new Intent(Choose_A_Accelerometer.this , Accelerometer.class));
                }
                else if(x_isOn == 1 && y_isOn ==1 && z_isOn == 0){
                    startActivity(new Intent(Choose_A_Accelerometer.this , AccelerometerXY.class));
                }else if(x_isOn == 1 && y_isOn ==0 && z_isOn == 1){
                    startActivity(new Intent(Choose_A_Accelerometer.this , AccelerometerXZ.class));
                }else if(x_isOn == 0 && y_isOn ==1 && z_isOn == 1){
                    startActivity(new Intent(Choose_A_Accelerometer.this , AccelerometerYZ.class));
                }else
                {
                    //doNothing
                }
