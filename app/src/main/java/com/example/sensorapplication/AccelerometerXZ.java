...
public class AccelerometerXZ extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accelerometer_xz);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AccelerometerXZ.this,AccelerometerXZ.class);
